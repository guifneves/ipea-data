...
dummy_pipeline = DummyOperator(task_id = "dummy1",queue = worker_queue, dag = dag)
dummy_pipeline2 = DummyOperator(task_id = "dummy2",queue = worker_queue, dag = dag)

get_metadata >> save_metadata >> clear_timeseries
clear_timeseries >> get_timeseries_agropecuaria >> save_timeseries_agropecuaria
save_timeseries_agropecuaria >> get_timeseries_seguranca_publica >> save_timeseries_seguranca_publica >> dummy_pipeline
save_timeseries_agropecuaria >> get_timeseries_financas_publicas >> save_timeseries_financas_publicas >> dummy_pipeline
dummy_pipeline >> get_timeseries_deputado_federal >> save_timeseries_deputado_federal >> dummy_pipeline2
dummy_pipeline >> get_timeseries_deputado_estadual >> save_timeseries_deputado_estadual >> dummy_pipeline2
dummy_pipeline >> get_timeseries_contas_regionais >> save_timeseries_contas_regionais >> dummy_pipeline2
dummy_pipeline >> get_timeseries_presidente >> save_timeseries_presidente >> dummy_pipeline2
dummy_pipeline >> get_timeseries_governador >> save_timeseries_governador >> dummy_pipeline2
dummy_pipeline >> get_timeseries_populacao >> save_timeseries_populacao >> dummy_pipeline2
dummy_pipeline >> get_timeseries_senador >> save_timeseries_senador >> dummy_pipeline2
dummy_pipeline >> get_timeseries_vereador >> save_timeseries_vereador >> dummy_pipeline2
dummy_pipeline >> get_timeseries_moeda_e_credito >> save_timeseries_moeda_e_credito >> dummy_pipeline2
dummy_pipeline2 >> get_timeseries_assistencia_social >> save_timeseries_assistencia_social >> save_relationship_table
dummy_pipeline2 >> get_timeseries_balanco_de_pagamentos >> save_timeseries_balanco_de_pagamentos >> save_relationship_table
dummy_pipeline2 >> get_timeseries_cambio >> save_timeseries_cambio >> save_relationship_table
dummy_pipeline2 >> get_timeseries_comercio_exterior >> save_timeseries_comercio_exterior >> save_relationship_table
dummy_pipeline2 >> get_timeseries_consumo_e_vendas >> save_timeseries_consumo_e_vendas >> save_relationship_table
dummy_pipeline2 >> get_timeseries_contas_nacionais >> save_timeseries_contas_nacionais >> save_relationship_table
dummy_pipeline2 >> get_timeseries_correcao_monetaria >> save_timeseries_correcao_monetaria >> save_relationship_table
dummy_pipeline2 >> get_timeseries_demografia >> save_timeseries_demografia >> save_relationship_table
dummy_pipeline2 >> get_timeseries_desenvolvimento_humano >> save_timeseries_desenvolvimento_humano >> save_relationship_table
dummy_pipeline2 >> get_timeseries_economia_internacional >> save_timeseries_economia_internacional >> save_relationship_table
dummy_pipeline2 >> get_timeseries_educacao >> save_timeseries_educacao >> save_relationship_table
dummy_pipeline2 >> get_timeseries_eleitorado >> save_timeseries_eleitorado >> save_relationship_table
dummy_pipeline2 >> get_timeseries_emprego >> save_timeseries_emprego >> save_relationship_table
dummy_pipeline2 >> get_timeseries_estoque_de_capital >> save_timeseries_estoque_de_capital >> save_relationship_table
dummy_pipeline2 >> get_timeseries_financeiras >> save_timeseries_financeiras >> save_relationship_table
dummy_pipeline2 >> get_timeseries_geografico >> save_timeseries_geografico >> save_relationship_table
dummy_pipeline2 >> get_timeseries_habitacao >> save_timeseries_habitacao >> save_relationship_table
dummy_pipeline2 >> get_timeseries_idhm2000 >> save_timeseries_idhm2000 >> save_relationship_table
dummy_pipeline2 >> get_timeseries_indicadores_sociais >> save_timeseries_indicadores_sociais >> save_relationship_table
dummy_pipeline2 >> get_timeseries_mercado_de_trabalho >> save_timeseries_mercado_de_trabalho >> save_relationship_table
dummy_pipeline2 >> get_timeseries_percepcao_e_expectativa >> save_timeseries_percepcao_e_expectativa >> save_relationship_table
dummy_pipeline2 >> get_timeseries_precos >> save_timeseries_precos >> save_relationship_table
dummy_pipeline2 >> get_timeseries_prefeito >> save_timeseries_prefeito >> save_relationship_table
dummy_pipeline2 >> get_timeseries_producao >> save_timeseries_producao >> save_relationship_table
dummy_pipeline2 >> get_timeseries_projecoes >> save_timeseries_projecoes >> save_relationship_table
dummy_pipeline2 >> get_timeseries_renda >> save_timeseries_renda >> save_relationship_table
dummy_pipeline2 >> get_timeseries_salario_e_renda >> save_timeseries_salario_e_renda >> save_relationship_table
dummy_pipeline2 >> get_timeseries_saude >> save_timeseries_saude >> save_relationship_table
dummy_pipeline2 >> get_timeseries_sinopse_macroeconomica >> save_timeseries_sinopse_macroeconomica >> save_relationship_table
dummy_pipeline2 >> get_timeseries_transporte >> save_timeseries_transporte >> save_relationship_table
dummy_pipeline2 >> get_timeseries_vendas >> save_timeseries_vendas >> save_relationship_table